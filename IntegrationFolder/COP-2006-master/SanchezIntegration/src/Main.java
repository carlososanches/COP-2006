...
public class Main {
   ...
   public static void main(String[] args) {
	   ...
	   // When a variable is declared with final keyword, its value can’t be modified. This means that you must initialize a final variable. 
	    ...
	    System.out.println("Below is an example of my class called Car");
	    
	    Car MyCar = new Car();
	       MyCar.setModel("Toyota Carolla");
	       MyCar.setColor("Black");
	       MyCar.setYear(2015);
	       MyCar.setMiles(60000);
	       
	       int miles = MyCar.getMiles();
	       String color = MyCar.getColor();
	       int year = MyCar.getYears();
	       ...
	       int num = 1;
           while (num <= 5) {
          System.out.println("Count to five with me! \n" + num);
          num++;
 }  
